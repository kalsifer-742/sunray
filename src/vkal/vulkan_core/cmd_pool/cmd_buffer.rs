...
pub fn new_vec(cmd_pool: vk::CommandPool, device: &vkal::Device, len: u32) -> Result<Vec<vk::CommandBuffer>, Box<dyn Error>> {
    new_vec_impl(cmd_pool, device, vk::CommandBufferLevel::PRIMARY, len)
}
pub fn new_vec_secondary(cmd_pool: vk::CommandPool, device: &vkal::Device, len: u32) -> Result<Vec<vk::CommandBuffer>, Box<dyn Error>> {
...
fn new_vec_impl(cmd_pool: vk::CommandPool, device: &vkal::Device, level: vk::CommandBufferLevel, len: u32) -> Result<Vec<vk::CommandBuffer>, Box<dyn Error>> {
